        ...
        if data_type == 'huatuo':
            ...
            with open(input_file, 'r', encoding='utf-8') as file:
                ...
                for data in origin_data:
                    ...
                    standard_dict['instances'][0]['input'] = data.get('input', "")
                    standard_dict['instances'][0]['output'] = data.get('output', "")
                    format_data.append(standard_dict)
        else:
            for line in origin_data:
                data = json.loads(line)
                ...
                if data.get('instances', ""):
                    standard_dict = {"instruction": "", "instances": [{"input": "", "output": ""}]}
                    standard_dict['instruction'] = data['instruction']
                    standard_dict['instances'] = data.get('instances', "")
                    format_data.append(standard_dict)
...
if __name__ == '__main__':
    ...
    # concat data
    generate_sft_raw_data_file = 'data/output/sft_data_raw_1.jsonl'
